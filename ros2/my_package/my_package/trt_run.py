...
class MyGetZedInfo(Node):
    def __init__(self):
        ...
        # for trt
        engine_file = '/home/xtrana/ros2_ws/src/my_package/trt_engines/landing_134.engine'
        ...
        self.y_trt = yolov8_trt(engine_file_path=engine_file, input_size=INPUT_SIZE, output_shape=OUTPUT_SHAPE)
    ...
    def detect(self):
            ...
            self.get_logger().info("running trt detection ... ")
            # run inference
            raw_img, box, conf, target_found = self.y_trt.infer(input_img=input_img) 
            ...
            if target_found: 
                ...
                self.get_logger().info("No target has been found")
